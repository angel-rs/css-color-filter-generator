// KDR ColorRadio const
let colorRadio = document.getElementById("color-radio");
// Sorry for create a new var xD
let inputprovitional = document.getElementById("color-input");
